...
from sgcProject.config import ARQ_API_KEY
from sgcProject.config import BOT_NAME as bn
from sgcProject.config import DURATION_LIMIT
from sgcProject.config import UPDATES_CHANNEL as updateschannel
from sgcProject.config import que
from sgcProject.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,BOT_USERNAME, OWNER
from sgcProject.function.admins import admins as a
from sgcProject.helpers.admins import get_administrators
from sgcProject.helpers.channelmusic import get_chat_id
from sgcProject.helpers.errors import DurationLimitError
from sgcProject.helpers.decorators import errors
from sgcProject.helpers.decorators import authorized_users_only
from sgcProject.helpers.filters import command, other_filters
from sgcProject.helpers.gets import get_file_name
from sgcProject.services.callsmusic import callsmusic
from sgcProject.services.callsmusic.callsmusic import client as USER
from sgcProject.services.converter.converter import convert
from sgcProject.services.downloaders import youtube
from sgcProject.services.queues import queues
...
def cb_admin_check(func: Callable) -> Callable:
    async def decorator(client, cb):
        ...
        if cb.from_user.id in admemes:
            ...
            await cb.answer("lu siapa bodoh!", show_alert=True)
            return
...
async def play(_, message: Message):
    ...
    if message.chat.id in DISABLED_GROUPS:
        return    
    lel = await message.reply("🔄 **sabar gw lagi nyari lagunya zzz**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>⛑ Flood Wait Error ⛑\n{user.first_name} gimana mau nyanyi lolz  dengan grup Anda karena banyaknya permintaan bergabung untuk userbot! Pastikan pengguna tidak dibanned dalam grup."
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/sobatgabutz"),
                    InlineKeyboardButton("⛑ Channel", url="https://t.me/sobatgabutzz"),
                ],
        ...
        query = toxt
        await lel.edit("🎵 **sabar gw lagi nyari lagunya zzz**")
        ...
        try:
            ...
            await lel.edit(
                "**ini lagu apaan woi ! .** Coba ketik yang bener zzz , Ketik `/help` bila butuh bantuan"
            )
            print(str(e))
            return
        dlurl=url
        ...
        try:
          ...
          await lel.edit("**judulnya apaan ? !**")
       
        try:
            toxxt = "**__buruan pilih mau yang mana ? :__**\n\n"
            j = 0
            useer=user_name
            ...
            while j < 5:
                ...
                toxxt += f" └ ⚡ __Powered by sgc Music Project__\n\n"
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        try:
            ...
            message.reply("**vcgnya belom di nyalain woi , gw gimana mau nyanyi lolz **")
            return
        await message.reply_photo(
            photo="final.png",
...
async def deezer(client: Client, message_: Message):
    if message_.chat.id in DISABLED_GROUPS:
        return
    global que
    lel = await message_.reply("🔄 **sabar gw lagi nyari lagunya zzz**")
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [InlineKeyboardButton(text="⛑ Channel", url="https://t.me/sobatgabutzz")],
        ]
    )
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        try:
            ...
            res.edit("vcgnya belom di nyalain woi , gw gimana mau nyanyi lolz ")
            return
...
async def lol_cb(b, cb):
    ...
    try:
        ...
        await cb.message.edit("ini lagu apaan woi ! ")
        return
    ...
    keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📌 Groups", url="https://t.me/sobatgabutz"),
                    InlineKeyboardButton("🛡️ Channel", url="https://t.me/sobatgabutzz"),
                ],
                [InlineKeyboardButton(text="🗑 Close", callback_data="cls")],
            ]
        )
