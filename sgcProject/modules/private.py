...
import logging
from sgcProject.modules.msg import Messages as tr
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, Message
from sgcProject.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL,BOT_USERNAME, OWNER
...
async def start_(client: Client, message: Message):
    await message.reply_text(
        f"""<b>Heyyoo {message.from_user.first_name} saya adalah {PROJECT_NAME}\n
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "📜 Cara Menggunakan BOT 📜", url="https://t.me/insecuremanz"
                    )
                ]
            ]
        ),
